const navBar = document.createElement("h1");
   ...
   navBar.innerHTML = "<h1>Calculator</h1>"

   const paraTag = document.createElement("p");
   paraTag.setAttribute("id","description");
   paraTag.innerHTML = "This My New Calculator Design using DOM and CSS and Bootstrap"
...
//DOM - Calculator Working process Function
